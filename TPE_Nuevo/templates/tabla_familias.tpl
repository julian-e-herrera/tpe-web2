         ...
         <table id="tabla-familia">
                ...
                <tbody>
                 {foreach from=$familias item=familia}
                    ...
                    <td><a href="/tpe/tpe-web2/TPE_Nuevo/borrar/familia/{$familia->id_familia}">BORRAR</a></td>
                    <td><a href="/tpe/tpe-web2/TPE_Nuevo/actualizar/familia/{$familia->id_familia}">ACTUALIZAR</a></td>
            ...
            {include 'templates/agregarFamilia.tpl'}
